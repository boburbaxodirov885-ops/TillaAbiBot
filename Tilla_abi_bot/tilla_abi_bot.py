...
# === Sozlamalar ===
API_TOKEN = "8452694935:AAEkdibaq00y1Tc9070WB4DK4rHvFm8M1Fc"  # BotFather'dan olingan token
ADMIN_ID = 1182191962  # userinfobot dan olingan ID
...
async def init_db():
    async with aiosqlite.connect("tillaabi.db") as db:
        ...
        # boshlang'ich narx agar yo'q bo'lsa
